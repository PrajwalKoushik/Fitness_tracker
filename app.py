...
st.markdown("""
    <style>
        ...
        .css-1d391kg, .css-1v3fvcr, .stTextInput, .stSlider, .stRadio, .stButton, h1, h2, h3, h4, h5, h6, p, label, span {
...
st.write("In this WebApp, you can observe your predicted calories burned. Pass your parameters such as `Age`, `Gender`, `BMI`, etc., and see the predicted kilocalories burned.")
